...
#'
#' @export
progression <- function(amount = 1.0, message = character(0L), step = NULL, time = Sys.time(), ..., type = c("update", "initiate", "finish"), class = NULL, progressor_uuid = NULL, progression_index = NULL, call = NULL, owner_session_uuid = NULL) {
